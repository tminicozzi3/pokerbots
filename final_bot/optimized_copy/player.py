...
class Player(Bot):
    ...
    def get_action(self, game_state, round_state, active):
        ...
        if continue_cost > 0:
            _SCARY = 0
            if continue_cost > 6 and continue_cost < 8:
                _SCARY = 0.05
            elif continue_cost > 8 and continue_cost < 9:
                _SCARY = 0.075
            elif continue_cost < 10 and continue_cost > 9:
                _SCARY = 0.1
            elif continue_cost < 70:
                _SCARY = -.307 + (0.189 * math.log(continue_cost))
            else:
                _SCARY = 0.48
